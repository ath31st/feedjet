  ...
  return (
    <Dialog.Root open={open} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 max-h-[85vh] w-lg max-w-[90vw] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-lg bg-(--card-bg) p-6 shadow-xl">
