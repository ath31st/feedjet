...
export function ThemeSwitcher() {
  ...
  return (
    <div className="fixed top-30 right-0 z-10 flex h-9 w-6 transform flex-col overflow-hidden rounded-l-lg bg-[var(--button-bg)] p-2 shadow-md transition-all duration-300 hover:h-64 hover:w-48">
