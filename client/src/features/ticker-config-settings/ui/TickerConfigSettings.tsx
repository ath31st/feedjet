...
interface TickerConfigSettingsProps {
  ...
  localConfig: TickerConfig;
  setLocalConfig: Dispatch<SetStateAction<TickerConfig | null>>;
  handleSave: () => void;
  handleReset: () => void;
  handleRollbackChanges: () => void;
}

export function TickerConfigSettings({
  isUpdating,
  isConfigLoading,
  localConfig,
  setLocalConfig,
    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="grid w-full grid-cols-2 gap-x-4 gap-y-3">
        ...
        <SliderControl
          ...
          step={1}
          onChange={(val) =>
            setLocalConfig((prev) => (prev ? { ...prev, paddingX: val } : prev))
          }
        />
