...
export const themesFull = [
  ...
  { name: 'dark', label: 'Ночное небо', color: '#0f172a' },
  ...
  { name: 'indigo', label: 'Индиго', color: '#4f46e5' },
  ...
  { name: 'terminal', label: 'Терминал', color: '#16a34a' },
  ...
  { name: 'moss', label: 'Мох', color: '#9dff35' },
